...
struct OnboardingWizardView: View {
    ...
    @State private var manualPort: Int = 31010
    @State private var manualPortText: String = "31010"
    ...
    private func applyModeDefaults(_ mode: OnboardingConnectionMode) {
        ...
        case .homeNetwork:
            ...
            self.manualTLS = true
            if self.manualPort <= 0 || self.manualPort > 65535 { self.manualPort = 31010 }
        case .remoteDomain:
