...
Use `adb reverse` so Android `localhost:31010` tunnels to your laptop `localhost:31010`.

Terminal A (gateway):

```bash
pnpm openclaw gateway --port 31010 --verbose
```

Terminal B (USB tunnel):

```bash
adb reverse tcp:31010 tcp:31010
```
