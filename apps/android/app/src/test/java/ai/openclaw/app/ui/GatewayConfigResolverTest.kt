...
class GatewayConfigResolverTest {
  ...
  fun parseGatewayEndpointUsesDefaultCleartextPortForBareWsUrls() {
    ...
    assertEquals(
      GatewayEndpointConfig(
        ...
        port = 31010,
        tls = false,
        displayUrl = "http://gateway.example:31010",
      ),
      parsed,
    )
  }
  ...
  fun resolveScannedSetupCodeAcceptsRawSetupCode() {
    val setupCode =
      encodeSetupCode("""{"url":"wss://gateway.example:31010","bootstrapToken":"bootstrap-1"}""")
  ...
  fun resolveScannedSetupCodeAcceptsQrJsonPayload() {
    ...
    val qrJson =
      ...
      {
        "setupCode": "$setupCode",
        "gatewayUrl": "wss://gateway.example:31010",
        "auth": "password",
  ...
  fun decodeGatewaySetupCodeParsesBootstrapToken() {
    ...
    assertEquals("wss://gateway.example:31010", decoded?.url)
  ...
  fun resolveGatewayConnectConfigPrefersBootstrapTokenFromSetupCode() {
    ...
    assertEquals(31010, resolved?.port)
