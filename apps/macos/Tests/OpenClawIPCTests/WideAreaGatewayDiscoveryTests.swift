    ...
    @Test func `discovers beacon from tailnet dns sd fallback`() {
        ...
        let context = WideAreaGatewayDiscovery.DiscoveryContext(
            ...
            dig: { args, _ in
                ...
                if recordType == "SRV" {
                    return "0 0 31010 steipetacstudio.openclaw.internal."
                }
                if recordType == "TXT" {
                    return "\"displayName=Peter\\226\\128\\153s Mac Studio (OpenClaw)\" \"gatewayPort=31010\" \"tailnetDns=peters-mac-studio-1.sheep-coho.ts.net\" \"cliPath=/Users/steipete/openclaw/src/entry.ts\""
                }
                return ""
            })
        ...
        #expect(beacon.port == 31010)
        #expect(beacon.gatewayPort == 31010)
