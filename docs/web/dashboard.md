...
- **Localhost**: open `http://127.0.0.1:31010/`.
...
- Ensure the gateway is reachable (local: `openclaw status`; remote: SSH tunnel `ssh -N -L 31010:127.0.0.1:31010 user@host` then open `http://127.0.0.1:31010/`).
