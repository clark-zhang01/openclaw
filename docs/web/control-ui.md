...
- [http://127.0.0.1:31010/](http://127.0.0.1:31010/) (or [http://localhost:31010/](http://localhost:31010/))
...
- `http://<tailscale-ip>:31010/` (or your configured `gateway.controlUi.basePath`)
...
- `http://127.0.0.1:31010/` (on the gateway host)
...
Then point the UI at your Gateway WS URL (e.g. `ws://127.0.0.1:31010`).
...
```text
http://localhost:5173/?gatewayUrl=ws://<gateway-host>:31010
```

Optional one-time auth (if needed):

```text
http://localhost:5173/?gatewayUrl=wss://<gateway-host>:31010#token=<gateway-token>
```
