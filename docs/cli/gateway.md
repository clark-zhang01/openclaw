...
- `--port <port>`: WebSocket port (default comes from config/env; usually `31010`).
...
```bash
openclaw gateway health --url ws://127.0.0.1:31010
```
...
- `gatewayPort` (WebSocket port, usually `31010`)
