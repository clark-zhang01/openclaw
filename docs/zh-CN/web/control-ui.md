...
- http://127.0.0.1:31010/（或 http://localhost:31010/）
...
- `http://<tailscale-ip>:31010/`（或你配置的 `gateway.controlUi.basePath`）
...
- `http://127.0.0.1:31010/`（在 Gateway 网关主机上）
...
然后将 UI 指向你的 Gateway 网关 WS URL（例如 `ws://127.0.0.1:31010`）。
