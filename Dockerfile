...
#
# IMPORTANT: With Docker bridge networking (-p 31010:31010), loopback bind
...
HEALTHCHECK --interval=3m --timeout=10s --start-period=15s --retries=3 \
  CMD node -e "fetch('http://127.0.0.1:31010/healthz').then((r)=>process.exit(r.ok?0:1)).catch(()=>process.exit(1))"
