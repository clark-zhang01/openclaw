...
describe("resolveHostName", () => {
  it("normalizes IPv4/hostname and IPv6 host forms", () => {
    const cases = [
      { input: "localhost:31010", expected: "localhost" },
      { input: "127.0.0.1:31010", expected: "127.0.0.1" },
      { input: "[::1]:31010", expected: "::1" },
      { input: "::1", expected: "::1" },
    ] as const;
...
describe("isLocalishHost", () => {
  ...
  it("rejects non-local hosts", () => {
    const rejected = ["example.com", "192.168.1.10", "203.0.113.5:31010"];
...
describe("isSecureWebSocketUrl", () => {
  it("defaults to loopback-only ws:// and rejects private/public remote ws://", () => {
    const cases = [
      // wss:// always accepted
      { input: "wss://127.0.0.1:31010", expected: true },
      { input: "wss://localhost:31010", expected: true },
      { input: "wss://remote.example.com:31010", expected: true },
      { input: "wss://192.168.1.100:31010", expected: true },
      // ws:// loopback accepted
      { input: "ws://127.0.0.1:31010", expected: true },
      { input: "ws://localhost:31010", expected: true },
      { input: "ws://[::1]:31010", expected: true },
      { input: "ws://127.0.0.42:31010", expected: true },
      // ws:// private/public remote addresses rejected by default
      { input: "ws://10.0.0.5:31010", expected: false },
      { input: "ws://10.42.1.100:31010", expected: false },
      { input: "ws://172.16.0.1:31010", expected: false },
      { input: "ws://172.31.255.254:31010", expected: false },
      { input: "ws://192.168.1.100:31010", expected: false },
      { input: "ws://169.254.10.20:31010", expected: false },
      { input: "ws://100.64.0.1:31010", expected: false },
      { input: "ws://[fc00::1]:31010", expected: false },
      { input: "ws://[fd12:3456:789a::1]:31010", expected: false },
      { input: "ws://[fe80::1]:31010", expected: false },
      { input: "ws://[::]:31010", expected: false },
      { input: "ws://[ff02::1]:31010", expected: false },
      // ws:// public addresses rejected
      { input: "ws://remote.example.com:31010", expected: false },
      { input: "ws://1.1.1.1:31010", expected: false },
      { input: "ws://8.8.8.8:31010", expected: false },
      { input: "ws://203.0.113.10:31010", expected: false },
      // invalid URLs
      { input: "not-a-url", expected: false },
      { input: "", expected: false },
      { input: "http://127.0.0.1:31010", expected: true },
      { input: "https://127.0.0.1:31010", expected: true },
      { input: "https://remote.example.com:31010", expected: true },
      { input: "http://remote.example.com:31010", expected: false },
    ] as const;
  ...
  it("allows private ws:// only when opt-in is enabled", () => {
    const allowedWhenOptedIn = [
      ...
      "http://10.0.0.5:31010",
      "ws://172.16.0.1:31010",
      "ws://192.168.1.100:31010",
      "ws://100.64.0.1:31010",
      "ws://169.254.10.20:31010",
      "ws://[fc00::1]:31010",
      "ws://[fe80::1]:31010",
      "ws://gateway.private.example:31010",
    ];
  ...
  it("still rejects ws:// public IP literals when opt-in is enabled", () => {
    const publicIpWsUrls = ["ws://1.1.1.1:31010", "ws://8.8.8.8:31010", "ws://203.0.113.10:31010"];
