...
vi.mock("../../commands/onboard-helpers.js", () => ({
  resolveControlUiLinks: () => ({ httpUrl: "http://127.0.0.1:31010" }),
}));
...
vi.mock("./status.gather.js", () => ({
  ...
  resolvePortListeningAddresses: () => ["127.0.0.1:31010"],
}));
    ...
    printDaemonStatus(
      {
        ...
        gateway: {
          ...
          probeUrl: "ws://127.0.0.1:31010",
        },
        port: {
          port: 31010,
          status: "busy",
          listeners: [{ pid: 9000, ppid: 8999, address: "127.0.0.1:31010" }],
          hints: [],
        },
        rpc: {
          ok: false,
